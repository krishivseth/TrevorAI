        ...
        <div className="w-full flex items-center justify-between mb-14">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              <input type="text" id="date-select" value="Aug 30-Sep 29, 2024" readOnly className="bg-blue-700 border border-blue-500 rounded px-2 py-1 text-sm focus:outline-none focus:ring-1 focus:ring-white" />
            </div>
